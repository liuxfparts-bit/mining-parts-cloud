      ...
      <div className="bg-white rounded-lg border overflow-hidden">
        <table className="w-full text-sm">
          <thead className="bg-gray-50 border-b">
            <tr><th className="text-left p-3">品牌</th><th className="text-left p-3">型号</th><th className="text-left p-3">名称</th><th className="text-left p-3">类型</th><th className="text-left p-3">件号数</th></tr>
          </thead>
          <tbody>
            {items.length === 0 ? <tr><td colSpan={5} className="p-6 text-center text-gray-500">暂无数据</td></tr> :
              items.map((e) => (
