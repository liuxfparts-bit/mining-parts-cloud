        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li><a href="#" className="hover:text-amber-400">会员服务</a></li>
              <li><a href="#" className="hover:text-amber-400">企业认证</a></li>
            </ul>
          </div>
          <div>
            <h4 className="text-white font-bold text-sm mb-3">平台</h4>
            <ul className="space-y-2 text-xs">
              <li><a href="#" className="hover:text-amber-400">关于我们</a></li>
              <li><a href="#" className="hover:text-amber-400">联系我们</a></li>
              <li><a href="#" className="hover:text-amber-400">服务协议</a></li>
              <li><a href="#" className="hover:text-amber-400">隐私政策</a></li>
            </ul>
          </div>
        </div>
